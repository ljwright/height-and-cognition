...
global clean 	"F:/IOE/Paper 3/Data"
...
label copy fed parent_edu_type
label define parent_edu_type -9899 "", modify
label values *_edu_type parent_edu_type
...
// Format Dataset
keep id cohort survey_weight_00 male age_* height_* bmi_* maths_* verbal_* vocab_* father_* mother_*
compress
...
save "${clean}/70c_temp", replace
use "${clean}/70c_temp", clear
...
// gen mother_edu_type = b516fq // NOT LABELLED CORRECTLY?
// gen father_edu_type = b516fq
// gen parent_edu_type = e190 if inrange(e190, 1, 7)

// Father's Social Class
recode A0014 	(1 = 1 "V Unskilled") (2 = 2 "IV Partly Skilled") ///
				(4 = 3 "III Skilled Manual") (3 = 4 "III Skilled Non-Manual") /// CHECK I HAVE CODING RIGHT FOR OTHER COHORTS
...
recode c3_4 	(1 = 1 "V Unskilled") (2 = 2 "IV Partly Skilled") ///
				(4 = 3 "III Skilled Manual") (3 = 4 "III Skilled Non-Manual") ///
				(5 = 5 "II Intermediate") (6 = 6 "I Professional") ///
				(min/-1 = .) (7/max = .), gen(father_class_10) // ADD VARIABLE THAT IS CONJUNCTION OF FATHER_CLASS_10 & _00

recode BD3INC	(6 = 1 "< £35") (5 = 2 "£35 - £49") (4 = 3 "£50 - £99") ///
				(3 = 4 "£100 - £149") (2 = 5 "£150 - £199") ///
				(1 = 6 "£200 - £249") (0 = 7 "£250+") ///
				(-1 = .) (8 = .), gen(family_income_10)				
...
// Own SEP
recode B9CSC 	(1 = 1 "V Unskilled") (2 = 2 "IV Partly Skilled") ///
				(3.1 = 3 "III Skilled Manual") (3.2 = 4 "III Skilled Non-Manual") ///
				(4 = 5 "II Intermediate") (5 = 6 "I Professional") ///
				(6 = .), gen(social_class_42)
				
recode BD7HACHQ	(7/8 = 1 "Degree or Higher") (4/6 = 2 "A Levels or Diploma") ///
				(1/3= 3 "O Levels or Vocational") (0 = 4 "None"), ///
				gen(education_34)
...
// gen mother_edu_type = mcs_mhq + 1 if inrange(mcs_mhq, 0, 5)
// gen father_edu_type = mcs_fhq + 1 if inrange(mcs_fhq, 0, 5)
...
* Age Adjusted
foreach var of varlist maths_7 maths_17 verbal_10 vocab_14{
	local age = substr("`var'", -2, .)
		
	regress `var' age_`age'_cog
	predict `var'_resid, residuals	
}
